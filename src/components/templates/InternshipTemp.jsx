...
export default function InternshipTemp({
  zoom,
  position,
  isDragging,
  activeCSS,
      ...
      >
        ...
        <div className={styles.bottomRow}>
          <div className={styles.dateBlock}>
            <p className={styles.label}>Date of issue</p>
            <p className={styles.value}>{formatDate(certData?.Date) || "<<date>>"}</p>
          </div>
          ...
          <div className={styles.signBlock}>
            ...
            />
            <p className={styles.orgName}>Skyy Skill Academy</p>
          </div>
        </div>
      </div>
    </div>
