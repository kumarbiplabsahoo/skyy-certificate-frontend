...
import CertImage from "../../assets/svg/college.png";
import QRCode from "react-qr-code";
import { useRef, useEffect } from "react";

export default function CollegeTemp({
  zoom,
  position,
  isDragging,
  activeCSS,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={styles.departmentNameBox}>
          <h1 className={styles.departmentName}>
            Department - {certData?.Duration || "Mechanical"}
          </h1>
        </div>
        ...
        <div className={styles.signatureWrapper}>
          ...
          <div className={styles.signatureContainer}>
            <div className={styles.signatureImageBox}>
              <img
                src={
                  certData?.Signature2?.preview || "/placeholder-signature.png"
                }
                alt="Signature 2"
                className={styles.signatureImage}
              />
