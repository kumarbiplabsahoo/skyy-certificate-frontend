...
export default function ClearanceTemp({
  zoom,
  position,
  isDragging,
  activeCSS,
  ...
  const replacedText = textTemplate
    ...
    .replace(/\[Collected Amount\]/g, certData?.Collected_Amount || "<CollectedAmount>")
    .replace(/\[Outstanding Dues\]/g, certData?.Outstanding_dues || "<Outstanding_dues>");
